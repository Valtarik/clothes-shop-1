        ...
        <div className="bg-gray-100 mt-16">
            <div className="bg-white p-6  md:mx-auto">
                ...
                <div className="text-center">
                    <h3 className="md:text-2xl text-base text-gray-900 font-semibold text-center">Замовлення
                        створено!</h3>
                    <p className="text-gray-600 my-2">Слідкуйте за замовленням, зареєструвавшись за допомогою email
                        адреси,
